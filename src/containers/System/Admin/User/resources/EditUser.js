...
export default function EditUser() {
    ...
    const { isLoggedIn, userInfo, language, genderRedux, roleRedux, positionRedux, isLoadingGender, listUsers } =
        useSelector((state) => ({
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <select
                        ...
                        value={gender}
                    >
                        <option value="">{language === LANGUAGES.VI ? 'Chọn giới tính' : 'Choose gender'}</option>
                        {genderArr &&
                            genderArr.length > 0 &&
