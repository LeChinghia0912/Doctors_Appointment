...
class ManageDoctor extends Component {
    ...
    render() {
        let { hasOldData, listSpecialty, listDoctorsRaw, firstName, lastName, position } = this.state;
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <select
                            ...
                            value={position}
                        >
                            <option value="">{language === LANGUAGES.VI ? 'Chọn chức danh' : 'Choose positon'}</option>
                            {positions &&
                                positions.length > 0 &&
                    ...
                    <div class="col-12">
                        <button onClick={() => this.handleFilterDoctors()} type="button" class="btn btn-primary mr-5">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button
                                            className="btn-edit"
                                            onClick={() => {
                                                this.props.navigate(`/admin-dashboard/manage-doctor/edit/${doctor.id}`, { replace: true });
                                            }}
                                        >
