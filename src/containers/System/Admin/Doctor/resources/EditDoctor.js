    ...
    render() {
        ...
        return (
            <div className="manage-doctor-container">
                ...
                <div className="more-infor-extra row">
                    ...
                    <div className="col-4 form-group">
                        ...
                        >
                            <option value="">
                                {this.props.language === 'en' ? 'Choose payment' : 'Chọn phương thức thanh toán'}
                            </option>
            ...
            /> */}
                ...
                <div className="row">
                    <div className="col-4 form-group">
                        ...
                        >
                            <option value="">
                                {this.props.language === 'en' ? 'Choose specialty' : 'Chọn chuyên khoa'}
                            </option>
            ...
            /> */}
                    ...
                    <div className="col-4 form-group">
                        <label>{this.props.language === 'en' ? 'Hospital' : 'Bệnh viện'}</label>
                        ...
                        >
                            <option value="">
                                {this.props.language === 'en' ? 'Choose hospital' : 'Chọn bệnh viện'}
                            </option>
