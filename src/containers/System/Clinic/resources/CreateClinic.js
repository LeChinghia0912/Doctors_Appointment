...
class CreateClinic extends Component {
    ...
    handleSaveNewClinic = async () => {
        ...
        setTimeout(function () {
            window.location.href = '/admin-dashboard/manage-clinic';
        }, 1000);
    };
        ...
        return (
            <div className="manage-specialty-container">
                <div className="ms-title">
                    <FormattedMessage id={'admin.manage-clinic.title-create'} />
                </div>
                ...
                <div className="add-new-specialty row">
                    ...
                    <div className="col-12">
                        <button className="btn btn-primary mt-30" onClick={() => this.handleSaveNewClinic()}>
