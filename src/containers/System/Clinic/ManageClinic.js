        ...
        return (
            <div className="manage-specialty-container">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <button onClick={() => this.handleFilterClinis()} type="button" class="btn btn-primary mr-5">
                ...
                <div class="row">
                    <div class="col-12 text-right mb-16">
                        <button
                            ...
                            onClick={() => {
                                this.props.navigate(`/admin-dashboard/manage-clinic/create`, { replace: true });
                            }}
                        >
                                ...
                                <tr>
                                    ...
                                    <td class="" colspan="2">
                                        <button
                                            className="btn-edit"
                                            onClick={() => {
                                                this.props.navigate(`/admin-dashboard/manage-clinic/edit/${clinic.id}`, { replace: true });
                                            }}
                                        >
                                            <i className="fas fa-pencil-alt"></i>
                                        </button>
                                        <button className="btn-delete" onClick={() => this.handleDeleteClinic(clinic.id)}>
