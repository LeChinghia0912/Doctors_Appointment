...
import { getDetailSpecialtyById, udateSpecialtyData } from '../../../../services/specialtyService';
...
class EditSpecialty extends Component {
    ...
    handleSaveNewSpecialty = async () => {
        ...
        let res = await udateSpecialtyData({
            id: specialtyId,
        ...
        return (
            <div className="manage-specialty-container">
                ...
                <div className="add-new-specialty row">
                    ...
                    <div className="col-12">
                        <button className="btn btn-primary mt-10" onClick={() => this.handleSaveNewSpecialty()}>
