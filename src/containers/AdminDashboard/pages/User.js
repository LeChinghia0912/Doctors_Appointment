        ...
        <Page title="User | Minimal-UI">
            <Container>
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                    ...
                    <Button variant="contained" component={RouterLink} to="#" startIcon={<Iconify icon="eva:plus-fill" />} onClick={() => handleAddNewUser()}>
                        New User
                    </Button>
                </Stack>
                                ...
                                <TableBody>
                                    {
                                        ...
                                        arrUsers.map((row) => {
                                            const { address, email, firstName, gender, id, image, lastName, phonenumber, positionId, roleId, createdAt } = row;
                                            let imageBase64 = '';
                                            if (image) {
                            ...
                            >
                              {sentenceCase(status)}
                                                    ...
                                                    <TableCell align="right">
                                                        <button className="btn-edit" onClick={() => handleEditUser(row)}>
                                                            <i className="fas fa-pencil-alt"></i>
                                                        </button>
                                                        <button className="btn-delete" onClick={() => handleDeleteUser(row)}>
                ...
                <ModalUser isOpen={isOpenModalUser} toggleFromParent={toggleUserModal} createNewUser={createNewUser} />
                {isOpenModalEditUser && <ModalEditUser isOpen={isOpenModalEditUser} toggleFromParent={toggleUserEditModal} currentUser={userEdit} editUser={doEditUser} />}
            </Container>
        </Page>
    );
}
