...
class DoctorExtraInfor extends Component {
    ...
    // hiển thị thông tin chi tiết phòng khám
                    ...
                    {isShowDetailInfor === false && (
                        <div className="short-infor">
                            ...
                            {extraInfor && extraInfor.priceTypeData && language === LANGUAGES.VI && (
                                <NumberFormat className="currency" value={extraInfor.priceTypeData.valueVi} displayType={'text'} thousandSeparator={true} suffix={'VND'} />
                            )}
