...
export default function LeftContent() {
    ...
    return (
        <div>
            ...
            <div class="my-20">
                <div class="font-weight-semi-bold text-uppercase text-secondary mb-16" style={{ fontSize: '13px' }}>
                ...
                >
                    <div class="col-auto avatar-profile" style={{ backgroundImage: `url(${previewImgURL})` }}></div>
                    <div class="col-auto">
                        <h2>
                            {firstName} {lastName}
                        </h2>
