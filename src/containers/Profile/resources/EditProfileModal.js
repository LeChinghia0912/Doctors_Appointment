...
class EditProfileModal extends Component {
    ...
    checkValidateInput = () => {
        let isValid = true;
        let arrCheck = ['email', 'firstName', 'lastName', 'address', 'phonenumber', 'gender'];
    ...
    render() {
        ...
        let { email, firstName, lastName, phonenumber, address, gender, avatar } = this.state;
        ...
        return (
            <LoadingOverlay active={false} spinner={<BounceLoader color={'#86e7d4'} size={60} />}>
                ...
                <Modal isOpen={isOpenModal} className={'edit-profile-modal-container'} size="lg" centered>
                    <div className="edit-profile-modal-content">
                        ...
                        <div className="edit-profile-modal-footer">
                            <button className="btn-edit-profile-confirm" onClick={() => this.handleSaveUser()}>
                                <FormattedMessage id="manage-user.confirm" />
                            </button>
                            <button className="btn-edit-profile-cancel" onClick={closeBookingClose}>
