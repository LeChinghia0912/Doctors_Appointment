            ...
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-10">
                        ...
                        <button type="button" class="btn btn-primary" onClick={() => handleResetDate()}>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div
                                                    ...
                                                    onClick={() => history.push(`/detail-doctor/${item.doctorId}`)}
                                                >
                                                ...
                                                >
                                                    {item.doctorDataHistory.Doctor_Infor.specialtyData.name}
                                                </div>
                                                <div
                                                    class="pointer text-primary"
                                                    onClick={() =>
                ...
                {isOpen === true && <Lightbox mainSrc={previewImgURL} onCloseRequest={() => setIsOpen(false)} />}
            </div>
        </LoadingOverlay>
    );
}
