...
export default function MyAccount() {
    ...
    return (
        <div>
                ...
                <div class="rsolution-card-body">
                    <div class="row">
                        <div class="col-auto pt-20">
                            <div
                                class="avatar-box"
                                style={{ width: '185px', height: '185px', backgroundImage: `url(${previewImgURL})` }}
                            ></div>
            ...
            <EditPasswordModal isOpenModal={isOpenModalEditPassword} closeEditPasswordClose={closeEditPasswordClose} />
            <EditProfileModal isOpenModal={isOpenModalBooking} closeBookingClose={closeBookingClose} />
        </div>
    );
}
