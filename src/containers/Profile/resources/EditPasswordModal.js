...
class EditPasswordModal extends Component {
    ...
    render() {
        ...
        let { currentPassword, newPassword, confirmPassword, eyeCurrentPassword, eyeNewPassword, eyeConfirmPassword } =
            this.state;

        return (
            <LoadingOverlay active={false} spinner={<BounceLoader color={'#86e7d4'} size={60} />}>
                <Modal isOpen={isOpenModal} className={'edit-profile-modal-container'} size="sm" centered>
                    <div className="edit-profile-modal-content">
                        <div className="edit-profile-modal-header">
                            ...
                            <span className="right">
                                <i className="fas fa-times" onClick={closeEditPasswordClose}></i>
                            </span>
                        </div>
                            ...
                            <div className="row">
                                <div className="col-12 form-group">
                                    ...
                                    <div class="custom-input-password">
                                        <input
                                            ...
                                            onChange={(event) => this.handleOnChangeInput(event, 'currentPassword')}
                                        />
                                        <i
                                            class={!eyeCurrentPassword ? 'fas fa-eye-slash' : 'far fa-eye'}
                                            onClick={() => this.setState({ eyeCurrentPassword: !eyeCurrentPassword })}
                                        ></i>
                                    </div>
                                </div>
                                ...
                                <div className="col-12 form-group">
                                    ...
                                    <div class="custom-input-password">
                                        ...
                                        />
                                        <i
                                            class={!eyeNewPassword ? 'fas fa-eye-slash' : 'far fa-eye'}
                                            onClick={() => this.setState({ eyeNewPassword: !eyeNewPassword })}
                                        ></i>
                                    </div>
                                </div>
                                ...
                                <div className="col-12 form-group">
                                    ...
                                    <div class="custom-input-password">
                                        ...
                                        />
                                        <i
                                            class={!eyeConfirmPassword ? 'fas fa-eye-slash' : 'far fa-eye'}
                                            onClick={() => this.setState({ eyeConfirmPassword: !eyeConfirmPassword })}
                                        ></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="edit-profile-modal-footer">
                            <button className="btn-edit-profile-confirm" onClick={() => this.handleEditPassword()}>
                                <FormattedMessage id="manage-user.confirm" />
                            </button>
                            <button className="btn-edit-profile-cancel" onClick={closeEditPasswordClose}>
