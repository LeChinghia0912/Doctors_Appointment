...
const getDetailSpecialtyById = (data) => {
    return axios.get(`/api/get-detail-specialty-by-id?id=${data.id}&location=ALL`);
};
...
export { filterSpecialties, udateSpecialtyData, getDetailSpecialtyById, deleteSpecialty };
